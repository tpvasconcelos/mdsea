...
from mdsea.vis import (
    blender_materials as b_materials,
...
class BlenderAnimation(Vis):
    ...
    def create_ref_particle(self, mat: Optional[Material] = None) -> None:
    ...
    def create_particle_system(self, mat: Optional[Material] = None) -> None:
    ...
    def run(self) -> None:
        ...
        for self.step in np.arange(0, self.sm.STEPS, self.frame_step):
            ...
            self.particle_sys.particle_systems[0].particles.foreach_set("location", coords)
    ...
    @staticmethod
    def set_view(shade: str = "RENDERED", perspective: str = "CAMERA") -> None:
        """ Set view. """
    ...
    def set_framelim(self, start: int = 1, end: Optional[int] = None) -> None:
    ...
    def setup_camera(
        ...
        """ Setup camera. """
        if loc is None:
            loc = (2.5 * self.sm.LEN_BOX, -0.75 * self.sm.LEN_BOX, 1.25 * self.sm.LEN_BOX)
        if rot is None:
    ...
    def add_light(self, where=None, loc: Optional[Tuple3] = None, rot: Optional[Tuple3] = None) -> None:
    ...
    def add_glasswalls(self):
        ...
        b_objects.glasswalls(self.engine, len_box=self.sm.LEN_BOX, except_=["bottom"])
